...
type PageParam struct {
	...
	Filter      string         `form:"filter" json:"filter"`             //复杂过滤条件,适用于复杂查询
...
type Filter struct {
	...
	And      []Filter `form:"and" json:"and" bson:"and" xml:"and" yaml:"and"`                          //处理And条件,适用于复杂查询
	Or       []Filter `form:"or" json:"or" bson:"or" xml:"or" yaml:"or"`                               //处理Or条件,适用于复杂查询
}
